        ...
        <div className={styles.modal}>
          <div className={styles.modalContent}>
            ...
            <div className={styles.text}>
              ...
              <br />
              <br />
              케이지에이에셋(주) 다움지사(이하 “회사”)는 「개인정보 보호법」 및
              「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 등에 관련
              법령을 준수하여 보험 상담 및 보험 서비스 제공 등의 업무처리를
              위하여 귀하로부터 최소한의 필수정보를 수집합니다. 제공된 모든
              개인정보는 별도의 동의가 없는 한 임의의 다른 용도로 사용하지
              않습니다.
              <br />
              <br />
              개인정보 수집 및 이용에 관한 동의
              ...
              1. 개인정보 수집 및 이용 목적
              <br />
              2.  보험상담, 보험리모델링 및 가입 권유를 위한 안내 및 서비스
              제공
              <br />
              3. 개인정보 수집 및 이용 항목
              <br />
              ...
              6. 동의일로부터 3년
              <br />
              7. 동의를 거부할 권리 및 동의를 거부할 경우의 불이익
              <br />
              8. 귀하는 개인정보 수집, 이용에 대한 동의를 거부할 권리가
              있습니다. 동의 거부 시 보험계약 상담 등의 서비스를 받으실 수
              없습니다.
              <br />
              <br />
              개인정보 제공에 관한 동의
              ...
              7. 성명, 연령, 연락처
              <br />
              8. 제공받는 자의 개인정보 보유 및 이용 기간
              <br />
              9. 동의일로부터 3년
              <br />
              10. 동의를 거부할 권리 및 동의를 거부할 경우의 불이익
              <br />
              11. 귀하는 개인정보 제공에 대한 동의를 거부할 권리가 있습니다.
              <br />
              ...
              ※동의 철회를 위한 안내
              <br />
              본 동의를 하시더라도 이후에 동의를 철회하거나 가입 권유 목적의
              연락에 대한 중단을 요청하실 수 있습니다.
              <br />
              연락처 : 케이지에이에셋(주) 다움지사(053-428-2001)
              <br />
              FP 황준윤(010-8699-7275)
            </div>
          </div>
        </div>
      )}
